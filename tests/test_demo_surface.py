...
def test_visible_universes_hides_the_bench_by_default():
    ...
    # never-graded observation and control assets stay back. (The set is the fixture
    # dir's now: FUND-UI-2 removed these from the product surface, so what is pinned
    # here is the classification, not a shipping list.)
